#!/usr/bin/env node
// citation-cross-check.eval.js — replay eval (born WITH the component; forge blocks ship until green).
// Replay case: fabricated-trace claims - file:line cited with no corresponding read (miya debugging-emit block a)
'use strict';
