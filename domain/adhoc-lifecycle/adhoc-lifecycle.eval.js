#!/usr/bin/env node
// adhoc-lifecycle.eval.js — replay eval (born WITH the component; forge blocks ship until green).
// Replay case: closed adhocs pile in active/ forever; quest/archive-quest.js never built
'use strict';
...
console.log('\nadhoc-lifecycle.eval: ' + (results.length - failed) + '/' + results.length + ' green');
