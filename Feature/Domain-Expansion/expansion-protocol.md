...
*Last updated: 2026-05-19 — triggers expanded to 4 buckets + step (0) visible checklist + step (11) worktree & branch close + step (10) commit-scope rule (all uncommitted paths, not authored-only).*
