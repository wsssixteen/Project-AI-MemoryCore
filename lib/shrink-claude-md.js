...
console.log(`shrink-claude-md: ${before} → ${after} lines (${replaced} sections → pointers). Untouched: Etanah non-negotiables, Phase 2 Closure, boot order, Disposition, File Ownership, System-Layer, Cost-Efficiency.`);
