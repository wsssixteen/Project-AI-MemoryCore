 ...
 * Data: system/telemetry/hook-fires.jsonl · system/slip-counts.jsonl · system/registry.jsonl
 *       · system/telemetry/contingency.json ({"status":"A-on-track"} default)
...
const FIRES = path.join(ROOT, 'system', 'telemetry', 'hook-fires.jsonl');
const SLIPS = path.join(ROOT, 'system', 'slip-counts.jsonl');
const CONTINGENCY = path.join(ROOT, 'system', 'telemetry', 'contingency.json');
