...
if (require.main === module) {
  ...
  // de-close-gate C6 (2026-09-08): DE close requires this screen to have been produced this session.
  try { fs.appendFileSync(path.join(ROOT, 'domain', 'de-close-gate', 'log.jsonl'), JSON.stringify({ ts: new Date().toISOString(), action: 'audit-briefing-ran', notWorking: (d.notWorking || []).length, rulings: (d.rulings || []).length }) + '\n'); } catch (_) {}
}
