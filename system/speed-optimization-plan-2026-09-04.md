...
| **§9 STATUS 2026-09-07** | miya /goal "Fix all except 7 & 10; add 7 & 10 to todo; then DE" | BUILT + eval-green: 9a 9b 9c 9d 9e 9f 9h (see changelog entry "Plan §9 P3 builds"). DEFERRED to `main/todo.md` Q2: 9g (adhoc 10-day sweep) · Redmine reconcile of 23 open blocks (office network). Eval repairs: 3 fixed (deploy-merge-surface 5/5 · cross-module-intake 9/9 · bpmn-check 10/11), 2 quarantined-classified (live-action-safety-gate FEATURE-INCOMPLETE · release merge-scenarios HANG). Battery after repairs: 100/101 green. Still red: bpmn-check E2 'verdict clean' — the corpus PPTPB.bpmn20.xml drifted since the eval baseline (2026-09-04 flowable work); needs a BPMN re-baseline, not a code fix. Remaining blind spots (9e): subagent/Workflow cost · MCP query counts · miya reaction beyond reask/correction/nod. | — | — |
