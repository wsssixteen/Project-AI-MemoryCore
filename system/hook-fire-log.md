...
> **Purpose:** Per-session record of system-layer hook fires. Each row = one hook firing event. Read by DE meta-audit step (12.5) to verify hook reliability.
>
...
| `system-edit-gate.js` | 0-N (per Edit on system-layer path) | Zero is fine for sessions without system-layer edits |
