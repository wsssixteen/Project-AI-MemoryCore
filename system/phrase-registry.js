...
//
// Output: system/phrase-registry.md (one table: |component|layer|phrases|), sorted by component.
...
function buildMarkdown(allRows) {
  ...
  lines.push('');
  lines.push('> AUTO-GENERATED by `system/phrase-registry.js` - DO NOT EDIT BY HAND.');
  lines.push('> Regenerate with `node system/phrase-registry.js`.');
  lines.push('');
