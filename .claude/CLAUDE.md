...
**Triggered enforcement (hooks fire deterministically — 35 registered in `.claude/settings.json` as of 2026-05-25 — added `word-ui-vocab-gate.js` + `session-items-manager.js`)**:
