...
t('S24 <3 reviews → carry-over, same lesson', () => { reset(small); run('review', '--date', '2026-09-07'); run('review', '--date', '2026-09-08'); const o = run('review', '--date', '2026-09-14'); ok(o.startsWith('Week 1 · Lesson 1'), o.split('\n')[0]); ok(o.includes('review 1 of 5')); });
...
t('S26 zero-review week (never opened) → carry-over', () => { reset(small); run('review', '--date', '2026-09-07'); const o = run('review', '--date', '2026-09-21'); ok(o.startsWith('Week 1 · Lesson 1')); });
t('S27 week <lesson> override', () => { reset(small); run('review', '--date', '2026-09-07'); ok(run('week', '2', '--date', '2026-09-07').includes('Lesson 2')); ok(run('review', '--date', '2026-09-08').startsWith('Week 2 · Lesson 2')); });
