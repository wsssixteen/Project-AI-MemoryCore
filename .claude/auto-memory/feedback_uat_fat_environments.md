...
3. `etanah-awam` repo local base `mlk/master` (corrected 2026-07-02 — AWAM mirrors PLP; local-test only, branch `mlk/<tracker>/<num>` for commit, stag-env/mlit downstream)
