...
| `worktree-cleanup-boot.js` | self | stale worktree metadata + decay-stub expiration | text reminder | rubric decay enforcement, future decay-stubs | Changing decay-check predicate changes decay enforcement |
